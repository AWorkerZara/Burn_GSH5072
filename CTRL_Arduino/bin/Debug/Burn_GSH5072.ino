...
uint32_t  Fixture_ChkSum;

extern String Ver ;
extern String FPS ;
extern String ImFormat ;
extern String PartNo ;
...
//    Serial.print("Write_ChkSum = " + String(Write_ChkSum, HEX) + "\r\n");
  ...
  else if(inMsg == "ReadFlash"){
    digitalWrite(ledPin, V_Action);
    delay(200);
    Read_24LC16B_EEPROM();
    Serial.print( "\r\nReadFlash(CRC32) = " + String(Read_ChkSum, HEX) + "\r\n");
    SkipCatchVoltage = true;
  }
  else if (inMsg == "OCam") {
    digitalWrite(ledPin, V_Action);
    SkipCatchVoltage = true;
  ...
  else if (inMsg == "ChkFixtureSum") {
    Chk_Now_Ver();
    Serial.print( "\r\nCheckFixture(CRC32) = " + String(Fixture_ChkSum, HEX) + "\r\n");
    SkipCatchVoltage = true;
  }
  else if(inMsg == "ShowVer"){
    Serial.print( "\r\n" + PartNo + " " + ImFormat + " " + FPS + " " + Ver + "\r\n");
    SkipCatchVoltage = true;
  }
